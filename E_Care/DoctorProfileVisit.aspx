<%@ Page Title="" Language="C#" MasterPageFile="~/Site2.Master" AutoEventWireup="true" CodeBehind="DoctorProfileVisit.aspx.cs" Inherits="E_Care.DoctorProfile" %>
...
<li class="lli"><a href="ArticleList.aspx"style="color: #006699;text-decoration:none">Articles</a></li>
    ...
    <div style="margin-bottom:0px;margin-left:129px;margin-right:129px;height:445px; background-color:ghostwhite" >
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="~/Photo/Doctor_with_Patient_RGB.jpg" Width="100%" Height="411px"  />
               </div>
    ...
    <div style="background-color:ghostwhite; text-align:center; height: 292px; margin-top:0px;margin-left:129px;margin-right:129px;text-align:left;">
        ...
        <div style="margin-top:0px;vertical-align:top;text-align:left;margin-left:20px;display:inline-block; width: 351px;">
               ...
               <asp:Label ID="Label1" runat="server" Text="(Practice Hours: 5:30pm to 8:30pm) " Font-Size="Large" Height="50px" Width="351px" ForeColor="#336699"></asp:Label>
                                             
        </div>
        <div style="margin-left:200px;display:inline-block">
             <div style="margin-left:20px;display:inline-block">
                <asp:Button ID="Button8" runat="server" Text="Send Message" Height="35px" Width="119px" ForeColor="White" BackColor="#CC0066" OnClick="Button8_Click" />
            </div>
             <div style="margin-left:20px;display:inline-block">
                <asp:Button ID="Button9" runat="server" Text="Articles" Height="35px" Width="119px" ForeColor="White" BackColor="#3366CC" OnClick="Button9_Click" />
            </div>
             <div style="margin-left:20px;display:inline-block">
                <asp:Button ID="Button10" runat="server" Text="Reviews" Height="35px" Width="119px" ForeColor="White" BackColor="#009999" OnClick="Button10_Click" />
            </div>
        </div>
        <br />
        <br />
                                     <span style="margin-top:0px;vertical-align:top;text-align:left;margin-left:20px">
               <asp:Label ID="Label22" runat="server" Text=" When do you want to come in? " Font-Size="Large" Height="50px" Width="373px" ForeColor="#89919C"></asp:Label>
                                                     </span>
          <div class="days" >
        ...
        <div class="prescription">
            <div style="margin-left:20px;display:inline-block">
                <asp:Button ID="Button1" runat="server" Text="Saturday" Height="50px" Width="121px" ForeColor="White" BackColor="#339966" OnClick="Button1_Click" />
            </div>
             <div style="margin-left:20px;display:inline-block">
                 <asp:Button ID="Button2" runat="server" Text="Sunday" Height="50px" Width="119px" ForeColor="White" BackColor="#339966" OnClick="Button2_Click" />
            </div>
             <div style="margin-left:20px;display:inline-block">
                 <asp:Button ID="Button3" runat="server" Text="Monday" Height="50px" Width="119px" ForeColor="White" BackColor="#339966" OnClick="Button3_Click" />
            </div>
             <div style="margin-left:20px;display:inline-block">
                 <asp:Button ID="Button4" runat="server" Text="Tuesday" Height="50px" Width="119px" ForeColor="White" BackColor="#339966" OnClick="Button4_Click" />
            </div>
             <div style="margin-left:20px;display:inline-block">
                 <asp:Button ID="Button5" runat="server" Text="Wednesday" Height="50px" Width="119px" ForeColor="White" BackColor="#339966" OnClick="Button5_Click" />
            </div>
             <div style="margin-left:20px;display:inline-block">
                 <asp:Button ID="Button6" runat="server" Text="Thursday" Height="50px" Width="119px" ForeColor="White" BackColor="#339966" OnClick="Button6_Click"/>
            </div>
             <div style="margin-left:20px;display:inline-block">
                 <asp:Button ID="Button7" runat="server" Text="Friday(closed)" Height="50px" Width="119px" ForeColor="White" BackColor="#339966" Enabled="False" OnClick="Button7_Click" />
            </div>
