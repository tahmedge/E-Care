...
namespace E_Care
{
    public partial class DoctorProfile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (IntroPage.usertype != 0 && IntroPage.usertype != 1)
            {
        ...
        {
            int count = ob.checkappointment(Data.docid, Data.pid, Day1.Text);
            if(count==0)
            {
                ob.insertappointment(Day1.Text, Data.docid, Data.pid, "5:30", 0, Day1.Text, Button1.Text);
                Button1.Text = Button1.Text + " " + "(Booked)";
                MessageBox.ShowMessage("You Have booked an appointment for this day!Wait for confirmation.", this.Page);
            }
            else
                MessageBox.ShowMessage("You Have already booked an appointment for this day!", this.Page);
        }

        protected void Button2_Click(object sender, EventArgs e)
        {
           int count = ob.checkappointment(Data.docid, Data.pid, Day2.Text);
           if (count == 0)
           {
               ob.insertappointment(Day2.Text, Data.docid, Data.pid, "5:30", 0, Day2.Text, Button2.Text);
               Button2.Text = Button2.Text + " " + "(Booked)";
               MessageBox.ShowMessage("You Have booked an appointment for this day!Wait for confirmation.", this.Page);
           }
           else
               MessageBox.ShowMessage("You Have already booked an appointment for this day!", this.Page);
        ...
        {
            int count = ob.checkappointment(Data.docid, Data.pid, Day3.Text);
            if (count == 0)
            {
                ob.insertappointment(Day3.Text, Data.docid, Data.pid, "5:30", 0, Day3.Text, Button3.Text);
                Button3.Text = Button3.Text + " " + "(Booked)";
                MessageBox.ShowMessage("You Have booked an appointment for this day!Wait for confirmation.", this.Page);
            }
            else
                MessageBox.ShowMessage("You Have already booked an appointment for this day!", this.Page);
        ...
        {
            int count = ob.checkappointment(Data.docid, Data.pid, Day4.Text);
            if (count == 0)
            {
                ob.insertappointment(Day4.Text, Data.docid, Data.pid, "5:30", 0, Day4.Text, Button4.Text);
                Button4.Text = Button4.Text + " " + "(Booked)";
                MessageBox.ShowMessage("You Have booked an appointment for this day!Wait for confirmation.", this.Page);
            }
            else
                MessageBox.ShowMessage("You Have already booked an appointment for this day!", this.Page);
        ...
        {
            int count = ob.checkappointment(Data.docid, Data.pid, Day5.Text);
            if (count == 0)
            {
                ob.insertappointment(Day5.Text, Data.docid, Data.pid, "5:30", 0, Day5.Text, Button5.Text);
                Button5.Text = Button5.Text + " " + "(Booked)";
                MessageBox.ShowMessage("You Have booked an appointment for this day!Wait for confirmation.", this.Page);
            }
            else
                MessageBox.ShowMessage("You Have already booked an appointment for this day!", this.Page);
        ...
        {
            int count = ob.checkappointment(Data.docid, Data.pid, Day6.Text);
            if (count == 0)
            {
                ob.insertappointment(Day6.Text, Data.docid, Data.pid, "5:30", 0, Day6.Text, Button6.Text);
                Button6.Text = Button6.Text + " " + "(Booked)";
                MessageBox.ShowMessage("You Have booked an appointment for this day!Wait for confirmation.", this.Page);
            }
            else
                MessageBox.ShowMessage("You Have already booked an appointment for this day!", this.Page);
        ...
        protected void Button7_Click(object sender, System.EventArgs e)
        {
            ...
            if (count == 0)
            {
                ob.insertappointment(Day7.Text, Data.docid, Data.pid, "5:30", 0, Day7.Text, Button7.Text);
                Button7.Text = Button7.Text + " " + "(Booked)";
                MessageBox.ShowMessage("You Have booked an appointment for this day!Wait for confirmation.", this.Page);
            }
            else
                MessageBox.ShowMessage("You Have already booked an appointment for this day!", this.Page);
