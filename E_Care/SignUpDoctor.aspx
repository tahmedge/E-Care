<%@ Page Language="C#"  AutoEventWireup="true" CodeBehind="SignUpDoctor.aspx.cs"   Inherits="E_Care.SignUpDoctor"%>
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
 ...
 <h1 style="color: #FFFFFF; background-color: #3366CC;margin-top: -10px;width:  100%;">
  ...
  <legend style="color: #009999; font-size: large;">Account Information</legend>
        <br />
      <asp:Label ID="Label5" runat="server" Text="Username" Width="200px"></asp:Label>
        <asp:TextBox ID="TextBox_Username" runat="server" Height="23px" Width="191px" OnTextChanged="TextBox1_TextChanged"></asp:TextBox>
        <br />
        <br />
      ...
      <asp:Label ID="Label10" runat="server" Text="Password" Width="200px"></asp:Label>
        ...
        <br />
       <br />
        <asp:Label ID="Label25" runat="server" Text="Referenced By" Width="193px"></asp:Label>
        <br />
        <asp:TextBox ID="TextBox_ReferenceBy" runat="server" Width="191px" OnTextChanged="TextBox4_TextChanged" TextMode="Password"></asp:TextBox>
        <asp:Label ID="Label26" runat="server" ForeColor="#999999" Text="(Username)"></asp:Label>
        <br />
 </fieldset>
...
<br />
    ...
    <fieldset style="width:   99%"><legend style="color: #CC0066; font-size: large;">
        Personal Information</legend>
             <asp:Label ID="Label12" runat="server" Text=" Full Name" Width="200px"></asp:Label>
        <asp:TextBox ID="TextBox_Fullname" runat="server" Width="221px" OnTextChanged="TextBox5_TextChanged"></asp:TextBox>
        <br />
       <br />
     <asp:Label ID="Label13" runat="server" Text=" Sex" Width="178px"></asp:Label>
                <asp:RadioButton ID="RadioButton3" runat="server" ForeColor="#FF0066"  GroupName="String1" 
                    Text="Male" OnCheckedChanged="RadioButton1_CheckedChanged" Checked="True" />

                <asp:RadioButton ID="RadioButton4" runat="server" ForeColor="#FF0066"  GroupName="String1" 
  ...
  <legend style="color: #3366CC; font-size: large;">Professional Information</legend>
         <asp:Label ID="Label1" runat="server" Text="Speciality" Width="200px"></asp:Label>
            ...
            <br />
                ...
                <asp:TextBox ID="TextBox_Workingon" runat="server" Width="185px" OnTextChanged="TextBox7_TextChanged"></asp:TextBox>
        ...
        <asp:TextBox ID="TextBox_Contactnumber" runat="server" Width="200px" OnTextChanged="TextBox4_TextChanged" TextMode="Number"></asp:TextBox>
            ...
            <br />
                ...
                <asp:Label ID="Label6" runat="server" Text="See patient from" Width="200px"></asp:Label>
            <br />
            <div style="width: auto;margin-left:150px">
          
            
            <asp:Label ID="Label22" runat="server" Text=" " Width="2px"></asp:Label>
          

                <asp:TextBox ID="TextBox_Timestart" runat="server" Width="108px" TextMode="Time" OnTextChanged="TextBox_Timestart_TextChanged"></asp:TextBox>
&nbsp;
          
<div style="text-align:center;display:inline-block">
            <asp:Label ID="Label23" runat="server" Text="to" Width="36px"></asp:Label>
      </div>    

                <asp:TextBox ID="TextBox_Timeend" runat="server" Width="108px" TextMode="Time" OnTextChanged="TextBox_Timeend_TextChanged"></asp:TextBox>
                </div>
              <br />
            <br />
  ...
  <legend style="color: #CC0066; font-size: large;">Online Ticket Appointment System</legend>
            ...
            <div style="margin-left:134px">
              ...
              <div style="margin-top:5px">
                         ...
                         <asp:TextBox ID="TextBox_Appointmentlimit" runat="server" TextMode="Number" Width="76px" MaxLength="2">20</asp:TextBox>
                     </div>
<br />
            
          <br />

          <asp:CheckBox ID="CheckBox_Assistant" runat="server" 
              Text="Associative account for assistant(Optional)" ForeColor="#FF6600" OnCheckedChanged="CheckBox_Assistant_CheckedChanged" AutoPostBack="True" />
            <br />
            <br />
      <asp:Label ID="Label20" runat="server" Text="  Password" Width="200px" Visible="False"></asp:Label>
        <asp:TextBox ID="TextBox_Assistantpassword" runat="server" Width="191px" OnTextChanged="TextBox_14" style="height: 22px" TextMode="Password" Visible="False"></asp:TextBox>
            <br />
          <br />
        <asp:Label ID="Label21" runat="server" Text="  Confirm Password" Width="200px" Visible="False"></asp:Label>
        <asp:TextBox ID="TextBox_Assistantconfirmpassword" runat="server" Width="191px" OnTextChanged="TextBox15_TextChanged" TextMode="Password" Visible="False"></asp:TextBox>
            <br />
            <br />
          <br />
  ...
  <legend style="color: #996633; font-size: large;">Terms and Mailing</legend>
            <br />
        
          <asp:CheckBox ID="CheckBox_Emailnotifications" runat="server" Text="I want to get email notifications from E-Care" OnCheckedChanged="CheckBox_Emailnotifications_CheckedChanged" />
        <br />
        
          <br />
        
          <asp:CheckBox ID="CheckBox_Termsandcondition" runat="server" Text="I have accepted the terms and condition of E-Care" OnCheckedChanged="CheckBox_Termsandcondition_CheckedChanged" />
        
          <br />
        <asp:Button ID="Button2" runat="server" Text="Submit" Width="124px" 
